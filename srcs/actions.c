...
/*   Updated: 2023/07/04 13:10:15 by minabe           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	take_forks(t_philo *philo_data)
{
	...
	if (print_log(philo_data, "has taken a fork"))
		return ;
...
void	eating(t_philo *philo_data)
{
	...
	if (print_log(philo_data, "is eating"))
		return ;
...
{
	if (print_log(philo_data, "is sleeping"))
		return ;
...
{
	if (print_log(philo_data, "is thinking"))
		return ;
}
